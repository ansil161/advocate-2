  ...
  return (
    <Layout navTheme="dark">
      <PageMeta
        ...
        description="Representative matter types from the firm's practice — SARFAESI recovery, partition suits, constitutional writs and criminal quashing. Case details are withheld to protect client confidentiality."
        path="/landmark-cases"
      />
