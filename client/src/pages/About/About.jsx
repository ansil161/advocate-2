  ...
  return (
    <Layout navTheme="light">
      <PageMeta
        ...
        description="Founded in 2013 by Senior Advocate Sridhar Lendalay, SLA Advocates is built on one conviction — a judgment is only as good as its execution. Eleven advocates, seventy-five years of combined courtroom experience."
        path="/about"
      />
      <AboutHero />
